...
@Transactional
public class ListEventPageTest extends BaseWebTest {
    ...
    public void rendersSuccessfully() {
        tester.startPage(ListEventPage.class);
    }

    @Test
    public void testIfFilterRendersSuccessfully() {
        tester.startPage(ListEventPage.class,
                ListEventPage.parametersWith("place", "Tomas", "Cili"));
    }
}