...
@Transactional
public class SpamAdminPageTest extends BaseWebTest {
    ...
    @Test
    public void testIfPageAndItsPanelsRender() {
        tester.startPage(SpamAdminPage.class);
        tester.assertComponent("threatEventsListPanel", 
                SpamListPanel.class);
    }
}