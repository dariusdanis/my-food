...
@Transactional
public class EditEventPageTest extends BaseWebTest {
    ...
    public void rendersSuccessfully() {
        ...
        mockEvent.setCreatedBy(userService.merge(
                new User("tprupsys@gmail.com", "Tomas", "Rupsys")).getId());
        ...
        tester.startPage(EditEventPage.class,
                EditEventPage.parametersWith(mockEvent.getEventId()));
    }
}